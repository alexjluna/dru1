 ...
 */
class LunaMessageModuleListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new LunaMessageModuleListBuilder object.
   *
  ...
  public function buildRow(EntityInterface $entity) {
    /** @var \Drupal\luna_message\LunaMessageModuleInterface $entity */
    $row['id'] = $entity->id();
